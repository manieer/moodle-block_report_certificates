 ...
 *
 * Strings for component 'block_report_certificates', language 'en', branch 'totara-2.2'
 * @package totara
...
$string['report_certificates_footermessage'] = 'View and Download My Certificates';
$string['report_certificates_noreports'] = 'You do not have any certificates issued to you.';
$string['report_certificates_noduedate'] = 'No due date for this course.';
